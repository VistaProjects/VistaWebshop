...
route.get('/cart', function(req, res) {
  ...
  //console.log(req.cookies.node_express_ecommerce);
  if(req.cookies.node_express_ecommerce) {
    res.render('cart', {title: 'Winkelwagen', products: req.cookies.node_express_ecommerce});
  } else {
    res.render('cart', {title: 'Winkelwagen', products: products});
  }
...
route.get('/checkout', function(req, res) {
  ...
  res.render('order', {title: 'Checkout', products: products});
});
